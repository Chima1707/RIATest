    ...
    */
    ...
    function initTooltip () {
      if (!tooltip || !tooltip.node()) {
        ...
        tooltip.enter().append('div')
                   .attr('class', 'nvtooltip ' + (classes || 'xy-tooltip'))
                   .attr('id', id)
    ...
    nvtooltip._options = Object.create({}, {
      ...
      position: {get: function () { return position }, set: function (_) { position = _ }},
        ...
        // Deprecated options
      chartContainer: {get: function () { return document.body },
        set: function (_) {
            // deprecated after 1.8.3
          nv.deprecated('chartContainer', 'feature removed after 1.8.3')
        }},
      fixedTop: {get: function () { return null },
        set: function (_) {
            // deprecated after 1.8.1
          nv.deprecated('fixedTop', 'feature removed after 1.8.1')
        }},
      offset: {get: function () { return {left: 0, top: 0} },
        set: function (_) {
            // deprecated after 1.8.1
      ...
      hidden: {get: function () { return hidden },
        set: function (_) {
          if (hidden != _) {
            hidden = !!_
            nvtooltip()
...
*/
  ...
  nv.models.axis = function () {
    ...
    chart._options = Object.create({}, {
      ...
      margin: {get: function () { return margin },
        set: function (_) {
  ...
  nv.models.boxPlotChart = function () {
    ...
    chart._options = Object.create({}, {
      ...
      rightAlignYAxis: {get: function () { return rightAlignYAxis },
        set: function (_) {
          rightAlignYAxis = _
...
// http://projects.instantcognition.com/protovis/bulletchart/
  ...
  nv.models.bullet = function () {
    ...
    chart._options = Object.create({}, {
      ...
      orient: {get: function () { return orient },
...
// http://projects.instantcognition.com/protovis/bulletchart/
    ...
    function chart (selection) {
      selection.each(function (d, i) {
        ...
        var tick = g.selectAll('g.nv-tick')
                .data(x1.ticks(ticks || (availableWidth / 50)), function (d) {
  ...
  nv.models.candlestickBar = function () {
    ...
    function chart (selection) {
      selection.each(function (data) {
        ...
        if (padData) { x.range(xRange || [availableWidth * 0.5 / data[0].values.length, availableWidth * (data[0].values.length - 0.5) / data[0].values.length ]) } else { x.range(xRange || [5 + barWidth / 2, availableWidth - barWidth / 2 - 5]) }
  ...
  nv.models.cumulativeLineChart = function () {
    ...
    chart._options = Object.create({}, {
      ...
      useInteractiveGuideline: {get: function () { return useInteractiveGuideline },
        set: function (_) {
...
// TODO: consider deprecating by adding necessary features to multiBar model
  ...
  nv.models.focus = function (content) {
    ...
    chart._options = Object.create({}, {
      ...
      interpolate: {get: function () { return content.interpolate() },
        set: function (_) {
          content.interpolate(_)
        }},
      xTickFormat: {get: function () { return xAxis.tickFormat() },
        set: function (_) {
          xAxis.tickFormat(_)
        }},
      yTickFormat: {get: function () { return yAxis.tickFormat() },
        set: function (_) {
          yAxis.tickFormat(_)
        }},
      x: {get: function () { return content.x() },
        set: function (_) {
          content.x(_)
        }},
      y: {get: function () { return content.y() },
        set: function (_) {
          content.y(_)
        }},
      rightAlignYAxis: {get: function () { return rightAlignYAxis },
  ...
  nv.models.forceDirectedGraph = function () {
    ...
    chart._options = Object.create({}, {
      ...
      noData: {get: function () { return noData }, set: function (_) { noData = _ }},
      nodeExtras: {get: function () { return nodeExtras },
        set: function (_) {
          nodeExtras = _
        }},
      linkExtras: {get: function () { return linkExtras },
        set: function (_) {
          linkExtras = _
        }}
    })
...
// TODO: consider deprecating and using multibar with single series for this
  nv.models.historicalBar = function () {
    ...
    function chart (selection) {
      selection.each(function (data) {
        ...
        if (padData) { x.range(xRange || [availableWidth * 0.5 / data[0].values.length, availableWidth * (data[0].values.length - 0.5) / data[0].values.length ]) } else { x.range(xRange || [0, availableWidth]) }
  ...
  nv.models.historicalBarChart = function (bar_model) {
    ...
    chart._options = Object.create({}, {
      ...
      duration: {get: function () { return transitionDuration },
        set: function (_) {
...
// candlestickChart is just a historical chart with candlestick bars and some tweaks
  ...
  nv.models.line = function () {
    ...
    function chart (selection) {
      ...
      selection.each(function (data) {
        ...
        groups.watchTransition(renderWatch, 'line: groups')
                .style('stroke-opacity', 1)
                .style('fill-opacity', function (d) { return d.fillOpacity || 0.5 })
    ...
    chart._options = Object.create({}, {
      ...
      isArea: {get: function () { return isArea },
        set: function (_) {
          isArea = d3.functor(_)
        }},
      x: {get: function () { return getX },
        set: function (_) {
          getX = _
          scatter.x(_)
        }},
      y: {get: function () { return getY },
        set: function (_) {
          getY = _
          scatter.y(_)
        }},
  ...
  nv.models.lineChart = function () {
    ...
    chart._options = Object.create({}, {
      ...
      brushExtent: {get: function () { return focus.brushExtent() }, set: function (_) { focus.brushExtent(_) }},
        ...
        // options that require extra logic in the setter
      focusMargin: {get: function () { return focus.margin },
        set: function (_) {
          if (_.top !== undefined) {
            margin.top = _.top
            marginTop = _.top
      ...
      interpolate: {get: function () { return lines.interpolate() },
        set: function (_) {
          lines.interpolate(_)
          focus.interpolate(_)
        }},
      ...
      x: {get: function () { return lines.x() },
        set: function (_) {
          lines.x(_)
          focus.x(_)
        }},
      y: {get: function () { return lines.y() },
        set: function (_) {
          lines.y(_)
          focus.y(_)
        }},
  ...
  nv.models.linePlusBarChart = function () {
    ...
    chart._options = Object.create({}, {
      ...
      focusMargin: {get: function () { return margin2 },
        set: function (_) {
      ...
      switchYAxisOrder: {get: function () { return switchYAxisOrder },
        set: function (_) {
  ...
  nv.models.multiBar = function () {
    ...
    chart._options = Object.create({}, {
      ...
      barColor: {get: function () { return barColor },
        set: function (_) {
  ...
  nv.models.multiBarChart = function () {
    ...
    function chart (selection) {
      ...
      selection.each(function (data) {
        ...
        chart.update = function () {
          if (duration === 0) { container.call(chart) } else {
    ...
    chart._options = Object.create({}, {
      ...
      barColor: {get: function () { return multibar.barColor },
        set: function (_) {
          multibar.barColor(_)
  ...
  nv.models.multiChart = function () {
    ...
    function chart (selection) {
      selection.each(function (data) {
        ...
        g.select('.nv-y1.nv-axis')
                .classed('nv-disabled', !series1.length)
                .attr('transform', 'translate(' + x.range()[0] + ',0)')

        g.select('.nv-y2.nv-axis')
                .classed('nv-disabled', !series2.length)
                .attr('transform', 'translate(' + x.range()[1] + ',0)')
    ...
    chart._options = Object.create({}, {
      ...
      useVoronoi: {get: function () { return useVoronoi },
        set: function (_) {
          useVoronoi = _
          lines1.useVoronoi(_)
          lines2.useVoronoi(_)
  ...
  nv.models.ohlcBar = function () {
    ...
    function chart (selection) {
      selection.each(function (data) {
        ...
        if (padData) { x.range(xRange || [availableWidth * 0.5 / data[0].values.length, availableWidth * (data[0].values.length - 0.5) / data[0].values.length ]) } else { x.range(xRange || [5 + w / 2, availableWidth - w / 2 - 5]) }
...
// http://bl.ocks.org/jasondavies/1341281
  nv.models.parallelCoordinates = function () {
    ...
    chart._options = Object.create({}, {
      ...
      undefinedValuesLabel: {get: function () { return undefinedValuesLabel }, set: function (_) { undefinedValuesLabel = _ }},
        ...
        // deprecated options
      dimensions: {get: function () { return dimensionData.map(function (d) { return d.key }) },
        set: function (_) {
            // deprecated after 1.8.1
      ...
      dimensionNames: {get: function () { return dimensionData.map(function (d) { return d.key }) },
        set: function (_) {
            // deprecated after 1.8.1
      ...
      dimensionFormats: {get: function () { return dimensionData.map(function (d) { return d.format }) },
        set: function (_) {
            // deprecated after 1.8.1
  ...
  nv.models.pie = function () {
    ...
    chart._options = Object.create({}, {
      ...
      pieLabelsOutside: {get: function () { return labelsOutside },
        set: function (_) {
          labelsOutside = _
          nv.deprecated('pieLabelsOutside', 'use labelsOutside instead')
        }},
        // depreciated after 1.7.1
      donutLabelsOutside: {get: function () { return labelsOutside },
        set: function (_) {
          labelsOutside = _
          nv.deprecated('donutLabelsOutside', 'use labelsOutside instead')
        }},
        // deprecated after 1.7.1
      labelFormat: {get: function () { return valueFormat },
        set: function (_) {
          valueFormat = _
      ...
      labelType: {get: function () { return labelType },
        set: function (_) {
          labelType = _ || 'key'
        }}
    })
  ...
  nv.models.sankey = function () {
    ...
    sankey._options = Object.create({}, {
      ...
      center: {get: function () { return center() },
        set: function (_) {
          if (typeof _ === 'function') {
            center = _
          }
        }},
      link: {get: function () { return link() },
        set: function (_) {
          if (typeof _ === 'function') {
            link = _
          }
      ...
      selection.each(function (data) {
        ...
        data.forEach(function (series, i) {
          series.values.forEach(function (point) {
            ...
            // Setup Scales
        var logScale = chart.yScale().name === d3.scale.log().name
            // remap and flatten the data for use in calculating the scales' domains
  ...
  nv.models.stackedArea = function () {
    ...
    chart._options = Object.create({}, {
      ...
      style: {get: function () { return style },
        set: function (_) {
          style = _
          switch (style) {
            case 'stack':
  ...
  nv.models.stackedAreaChart = function () {
    ...
    chart._options = Object.create({}, {
      ...
      x: {get: function () { return stacked.x() },
        set: function (_) {
          stacked.x(_)
          focus.x(_)
        }},
      y: {get: function () { return stacked.y() },
        set: function (_) {
          stacked.y(_)
          focus.y(_)
        }},
